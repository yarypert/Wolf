...
/*   Updated: 2017/05/04 18:00:11 by yarypert         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void	ak_bullet(t_ptr *ptr)
{
	...
	while (i < ptr->ak_mag)
	{
		mlx_put_image_to_window(ptr->mlx, ptr->win, ptr->sprt.akbul,
				0 + (7 * i), 0);
		i++;
	}
	i = 0;
	while (i < ptr->de_mag)
	{
		mlx_put_image_to_window(ptr->mlx, ptr->win, ptr->sprt.debul,
				0 + (22 * i), -5);
		i++;
	}
}
