...
/*   Updated: 2017/05/04 19:08:06 by yarypert         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void	init_wolf2(t_ptr *ptr)
{
	...
	{
		ptr->ray.stepx = -1;
		ptr->ray.sidedistx = (ptr->ray.rayposx - ptr->ray.mapx) *
			ptr->ray.deltadistx;
	}
	else
	{
		ptr->ray.stepx = 1;
		ptr->ray.sidedistx = (ptr->ray.mapx + 1.0 - ptr->ray.rayposx) *
			ptr->ray.deltadistx;
	}
}
...
void	init_wolf3(t_ptr *ptr)
{
	...
	{
		ptr->ray.stepy = -1;
		ptr->ray.sidedisty = (ptr->ray.rayposy - ptr->ray.mapy) *
			ptr->ray.deltadisty;
	}
	else
	{
		ptr->ray.stepy = 1;
		ptr->ray.sidedisty = (ptr->ray.mapy + 1.0 - ptr->ray.rayposy) *
			ptr->ray.deltadisty;
	}
}
...
{
	if (ptr->ray.side == 0)
		ptr->ray.perpwalldist = (ptr->ray.mapx - ptr->ray.rayposx +
				(1 - ptr->ray.stepx) / 2) / ptr->ray.raydirx;
	else
		ptr->ray.perpwalldist = (ptr->ray.mapy - ptr->ray.rayposy +
