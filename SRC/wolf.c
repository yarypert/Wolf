...
/*   Updated: 2017/05/02 07:51:30 by yarypert         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void	init_wolf(t_ptr *ptr)
{
	...
	map = ptr->map;
	ptr->ray.i = 0;
	ptr->ray.posX = ptr->player_j;
	ptr->ray.posY = ptr->player_i;
	ptr->ray.dirX = -1;
	ptr->ray.dirY = 0;
	ptr->ray.planeX = 0;
	ptr->ray.planeY = 0.66;
	while (ptr->ray.i < SIZE_X)
	{
		...
		ptr->ray.dirX = ptr->ray.dirX + ptr->ray.planeX + ptr->ray.cameraX;
		ptr->ray.dirY = ptr->ray.dirY + ptr->ray.planeY + ptr->ray.cameraX;
		init_wolf2(ptr);
		init_wolf3(ptr);
		init_wolf4(ptr);
		init_wolf5(ptr);
